...
res = res.blacklitterman()
d = display(
    'Table 6: View 1 + 2, View 2 more bullish (He & Litterman 1999)',
    assets,
    res)
d.disp()
# %%
...
res = res.blacklitterman()
d = display(
    'Table 7: View 1 & 2, View 1 less confident (He & Litterman 1999)',
    assets,
    res)
d.disp()
# %%
...
res = res.blacklitterman()
d = display(
    'Table 8: View 1, 2 & 3, View 1 less confident (He & Litterman 1999)',
    assets,
    res)
d.disp()
