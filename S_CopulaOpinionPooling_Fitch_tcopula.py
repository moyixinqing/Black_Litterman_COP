# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 16:29:16 2019
...
t_first = '2010-01-01'  # starting date
...
path = 'C:/Users/renxi/Documents/GitHub/Total_Return_Generator/databases/temporary-databases/'
data = pd.read_csv(path + 'db_Index_Ftich.csv', index_col=0)
# set timestamps
...
# Plot
port.plot(CVaR, Rstar[1:], 'Mean-CVaR Frontier')
p_ = np.argmin(CVaR)
